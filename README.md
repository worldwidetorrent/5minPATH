...
- execution-v0 shadow-sidecar boundaries plus frozen book-pricing, tradability, policy-decision, simple sizing, evidence storage, and a minimal fail-open shadow runtime
